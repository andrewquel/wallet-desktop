...
const LedgerWallet = require(_path.resolve(__dirname, './LedgerWallet
'))
...
function createWindow () {
  ...
  const iconpath = _path.resolve(__dirname, '/client/Wallet
...
.png')
    ...
    if (arg.action === 'detect') {
      ...
      if (!ledgercomm) {
       ...
       = new LedgerWallet
        ...
        .signPersonalMessage_async(arg.path, Buffer.from(arg.data)
              .toString('hex'))
        ...
        .signTransaction_async(arg.path, arg.data)
  ...
  const about = {
    ...
    click: () => openAboutWindow({
      icon_path: `${__dirname}/client/Wallet

  .png`,
      package_json_dir: __dirname,
      copyright: 'Copyright (c) 2017 Wallet

  ',
      homepage: 'https://Wallet

  .io/',
      bug_report_url: 'https://github.com/Wallet
  ...
  template = [
    ...
    },
    {
      ...
      submenu: [
        {
          label: 'Learn More',
          click () { require('electron').shell.openExternal('https://Wallet
